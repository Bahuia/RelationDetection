...
class Model(nn.Module):
    ...
    def similarity(self, question, relation_level_relation, word_level_relation):
        ...
        """
        # Question lstm layer.
        question_lstm_out = self.question_encoder(question)
        # Relation-level relation layer.
        relation_level_relation_lstm_out = self.relation_encoder(relation_level_relation)
        # Word-level relation layer.
        word_level_relation_lstm_out = self.relation_encoder(word_level_relation)
        #
